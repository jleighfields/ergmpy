...
# Cases are generated by benchmarks/r/gen_convex_hull_cases.R and committed,
# so this comparison runs without an R installation.
CASE_DIR = Path(__file__).resolve().parents[2] / "results" / "r" / "convex_hull"
